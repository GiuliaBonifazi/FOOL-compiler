...
public class FOOLParser extends Parser {
	...
	public static final int
		PLUS=1, DIV=2, MINUS=3, TIMES=4, LPAR=5, RPAR=6, CLPAR=7, CRPAR=8, SEMIC=9, 
		COLON=10, COMMA=11, EQ=12, GE=13, LE=14, NOT=15, AND=16, OR=17, ASS=18, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "PLUS", "DIV", "MINUS", "TIMES", "LPAR", "RPAR", "CLPAR", "CRPAR", 
			"SEMIC", "COLON", "COMMA", "EQ", "GE", "LE", "NOT", "AND", "OR", "ASS", 
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6462930984L) != 0)) {
					{
					setState(103);
					exp(0);
					setState(108);
